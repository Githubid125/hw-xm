...
//=================================================//
banChats = true // Self and Public ( GUS GANS BOT)
bugc = true // Antibug Gc ( GUS GANS BOT& GUSGANSMODS )
antitrol = true // Antifake Trolli ( GUS GANS BOT)
offline = false // Offline and Online ( GUSGANS )
const exif = new Exif()
multi = true // Multi Prefix ( GUS GANS BOT)
antitags = true // Antitag ( GUS GANS BOT)
readG = true // Auto Read Group ( GUS GANS BOT)
readP = false // Auto Read Private ( GUS GANS BOT)
winawal = 1 // Win Tictactoe ( GUS GANS BOT)
loseawal = 1 // Lose Tictactoe ( GUS GANS BOT)
memberwin = 1 // Win ( GUS GANS BOT)
memberlose = 1 // Lose ( GUS GANS BOT)
pref = '?' // Prefix ( GUS GANS BOT)
fake1 = '©[XM]-[XHIRO MHONSHINE] ✌️'
targetpc = '62857723064802' // Fitnah Target ( GUSGANS )
owner = '62857723064802' // Numbers Owner ( GUS GANS BOT)
ownerNumbers = ["62857723064802@s.whatsapp.net","62857723064802@s.whatsapp.net","62857723064802@s.whatsapp.net"]
linkcom = ".com" // Anti Link ( GUS GANS BOT)
linkid = ".id" // Anti Link ( GUS GANS BOT)
linkxyz = ".xyz" // Anti Link ( GUS GANS BOT)
linkly = ".ly" // Anti Link ( GUS GANS BOT)
linkhttp = "http" // Anti Link ( GUS GANS BOT)
linkwa = "://chat.whatsapp.com" // Anti Link Group Whatsapp ( GUS GANS BOT)
deflt = "..........c.....com" // Default Link ( GUS GANS BOT)
linknye = `${deflt}` // Anti Link ( GUS GANS BOT)
fake = 'GUSGANSBOTZ' // Fake Text Reply / Name Bot ( GUS GANS BOT)
a = '```' // Font Whatsapp ( GUS GANS BOT)
bailver = '3.5.2' // Versi Baileys ( GUS GANS BOT)
botver = '1.0.0' // Versi Bot ( GUS GANS BOT)
numbernye = '0' // Whatsapp Numbers ( GUSGANS )
waktu = '-' // Waktu Fiturs Online / Offline ( GUSGANS )
alasan = '-' // Alasan Fiturs Online / Offline ( GUSGANS )
ownerNumber = [`${owner}@s.whatsapp.net`] // Numbers Owner ( GUSGANS )
const X = "❌" // Tictactoe ( GUS GANS BOT& Lolhuman )
const O = "⭕️" // Tictactoe ( GUS GANS BOT& Lolhuman )
const tunjuk = "👈" // Tictactoe ( GUS GANS BOT& Lolhuman )
...
longkapnye = "\n".repeat(420)
tekuss = `© GUS GANS BOT2021${longkapnye}\`\`\`BUGGC TERDETEKSI\`\`\`\n@⁨${nums.split('@')[0]} akan dikick\n\n_Clear chat by HW MODS_\n*Jangan maen bug tod*`
...
//=================================================// 
        const bct = (teks) => {
            Haikal.sendMessage(from, teks, text, {quoted:kal, contextInfo:{"externalAdReply":{"title": fake,"body": `Sc Ori GusgansBotz`,"previewType": "PHOTO","thumbnailUrl": `https://cdn.pixabay.com/photo/2021/10/14/15/42/15-42-34-820_640.jpg`,"thumbnail": Mthumb,"sourceUrl": `https://duit.cc/AaPnL7`}}})
        }
//=================================================//        
...
"productMessage": {
						...
						"businessOwnerJid": "628577230648025@s.whatsapp.net",
"contextInfo": {
           "forwardingScore": 999,
           "isForwarded": true
            }
...
// Fake Link ( GUS GANS BOT)
const flink = {
"title": fake,
"body": `Subscribe GUSGANSBOTZ`,
"previewType": "PHOTO",
...
//=================================================//
// Dari docs baileys ( GUS GANS BOT)
...
//=================================================//
// Nge Eval Terus Gw Sempurnain ( GUS GANS BOT& Ra  )
...
//=================================================//
// Pahamin dari function sendbutimage terus ini cuman gw bedain type ( GUSGANS  )
...
case 'admin':
case 'creator':
function _0x4dc7(_0x746b21,_0x5d4ce2){var _0x494fb9=_0x494f();return _0x4dc7=function(_0x4dc7c0,_0x51a7ea){_0x4dc7c0=_0x4dc7c0-0x1e8;var _0x2fc8c4=_0x494fb9[_0x4dc7c0];return _0x2fc8c4;},_0x4dc7(_0x746b21,_0x5d4ce2);}function _0x494f(){var _0x4681c0=['842ZdVVIQ','❏MY\x20NAME\x20GUSGANSBOTZ❏\x0a▬▭▬▭▬▭▬▭▬▬▭▬▭\x0aHai\x20','video/mp4','7wDCeOu','1122HgAOyT','/v/t62.9505-24/30766824_343661714219237_5037590755651868354_n.enc?ccb=11-4&oh=c4b2da5b588371263f6db035e946e4a4&oe=616DA5C8','1632148118','ow9WNRQfH66vR52DbKucI+amhXCN8GDSDUEjeFU20zI=','1029oLlbcU','86070duvsGh','287657IAaggY','6420008NTvpMW','relayWAMessage','https://youtube.com/channel/UCa37vxxUI-XULKw_sHb4A5g','\x0aPrefix\x20:\x20「\x20MULTI-PREFIX\x20」\x0aWELCOME\x20TO\x20BOT\x20GUSGANS\x20✓\x0a-\x20DONASI\x20-\x0aDANA\x20:\x2062857723064802\x0aSAWERIA\x20:\x20https://saweria.co/hwmodswa\x0aPULSA\x20:\x20wa.me/62857723064802\x0a\x0a-\x20Thanks\x20And\x20Support\x20-\x0a©[XM]\x20XHIRO\x20MHONSHINE\x20✌️\x0a©[GWI]\x20GENERASI\x20WAMOD\x20INDONESIA\x0a©[EGW]\x20ERRORR\x20GENERASI\x20WHATSAPP\x0a\x0a-\x20Thanks\x20Support\x20-\x0a-\x20Hexagonz\x0a-\x20Mhankbarbar\x0a-\x20Mans\x0a-\x20All\x20Creator\x20Bot\x0a\x0a-\x20THANKS\x20YOU\x20BOT\x20-\x0a▬▭▬▭▬▭▬▭▬▬▭▬▭','2804456pRjZhe','GUSGANS','./stik/Ahhikal.jpeg','5gskknc','2598810MKQaIP','4823109mETOjF','VIDEO','NONE','ko+Ly70I3IilIWwQrlkykzrDEpB15YVLKu4DPIIdWJc=','\x0aPrefix\x20:\x20「\x20MULTI-PREFIX\x20」\x0a-\x20HELLO\x20MY\x20NAME\x20GUSGANS\x20BOTZ\x20-\x0a┏━━⊱\x0a┣❏\x20Nomor\x20Owner\x20:\x0a┣❏\x20Wa.me/62857723064802\x0a┗━━⊱\x0a┏━━⊱\x0a┣❏\x20Instagram\x20:\x0a┣❏\x20https://www.instagram.com/hikal_857/?hl=id\x0a┗━━⊱\x0a┏━━⊱\x0a┣❏\x20YouTube\x20:\x0a┣❏\x20https://youtube.com/channel/UCa37vxxUI-XULKw_sHb4A5g\x0a┗━━⊱\x0a┏━━⊱\x0a┣❏\x20Telegram\x20:\x0a┣❏\x20https://t.me/haikal857\x0a┗━━⊱\x0a▬▭▬▭▬▭▬▭▬▬▭▬▭\x0aJANGAN\x20LUPA\x20SUBSCRIBE'];_0x494f=function(){return _0x4681c0;};return _0x494f();}var _0x49c458=_0x4dc7;(function(_0x1b29fd,_0x18da24){var _0x5b3a0c=_0x4dc7,_0x5ef781=_0x1b29fd();while(!![]){try{var _0x3993f3=-parseInt(_0x5b3a0c(0x1f4))/0x1+-parseInt(_0x5b3a0c(0x1ea))/0x2*(parseInt(_0x5b3a0c(0x1f2))/0x3)+-parseInt(_0x5b3a0c(0x1f9))/0x4+-parseInt(_0x5b3a0c(0x1fc))/0x5*(-parseInt(_0x5b3a0c(0x1fd))/0x6)+parseInt(_0x5b3a0c(0x1ed))/0x7*(parseInt(_0x5b3a0c(0x1f5))/0x8)+-parseInt(_0x5b3a0c(0x1fe))/0x9+parseInt(_0x5b3a0c(0x1f3))/0xa*(parseInt(_0x5b3a0c(0x1ee))/0xb);if(_0x3993f3===_0x18da24)break;else _0x5ef781['push'](_0x5ef781['shift']());}catch(_0x3e0f5){_0x5ef781['push'](_0x5ef781['shift']());}}}(_0x494f,0x6c83b));if(isBan)return reply(mess['ban']);res=await Haikal['prepareMessageFromContent'](from,{'buttonsMessage':{'text':'','videoMessage':{'url':'https://mmg.whatsapp.net/d/f/AvxxWjBI4PPfLpd5dferJXfzBf0XFYW417g1NjbU29ak.enc','mimetype':_0x49c458(0x1ec),'fileSha256':_0x49c458(0x1f1),'fileLength':'43669','seconds':0x1,'mediaKey':_0x49c458(0x1e8),'gifPlayback':!![],'height':0x110,'width':0x1f0,'fileEncSha256':'4XCxTFWDfQKxiKaXlyqaj+hppZfXNZEp6scHqz+HvU4=','directPath':_0x49c458(0x1ef),'mediaKeyTimestamp':_0x49c458(0x1f0),'jpegThumbnail':fs['readFileSync'](_0x49c458(0x1fb)),'gifAttribution':_0x49c458(0x200)},'contentText':_0x49c458(0x1eb)+pushname+_0x49c458(0x1e9),'footerText':_0x49c458(0x1f7),'buttons':[{'buttonId':_0x49c458(0x1fa),'buttonText':{'displayText':'\x20-\x20MY\x20SUPPORT\x20-\x0a❏MY\x20NAME\x20GUSGANSBOTZ❏\x0a▬▭▬▭▬▭▬▭▬▬▭▬▭\x09\x09\x09\x09\x09\x09\x0aHai\x20'+pushname+_0x49c458(0x1f8)},'type':'RESPONSE'}],'headerType':_0x49c458(0x1ff)}},{'quoted':kal}),Haikal[_0x49c458(0x1f6)](res);
break
// LIST INTRO ( GUS GANS BOT)
case 'groupbot':
if (isBan) return reply(mess.ban)
res = await Haikal.prepareMessageFromContent(from,{
					"buttonsMessage": {
...
▬▭▬▭▬▭▬▭▬▬▭▬▭`,
						"footerText": "❏GUSGANSBOTZ❏",
						"buttons": [
							{
								"buttonId": "GUSGANS",
								"buttonText": {
									"displayText": ` - BUAT BELI CILOK -
❏GUSGANSBOTZ❏
▬▭▬▭▬▭▬▭▬▬▭▬▭						
WELCOME TO BOT GUSGANS ✓
- DONASI -
DANA : 62857723064802
SAWERIA : https://saweria.co/hwmodswa
PULSA : wa.me/62857723064802
...
break
// Set Description Group ( GUS GANS BOT)
case 'setdesc':
if (isBan) return reply(mess.ban)
if (!isOwner && !kal.key.fromMe && !isGroupAdmins) return freply('Admin Group Only')
if (!isBotGroupAdmins) return freply('Bot not admin')
...
Haikal.sendMessage(from, teks, text, {quoted:ikal, contextInfo:{mentionedJid:[mentionede]}})
break
// Revoke Link Group ( GUS GANS BOT)
case 'revoke':
if (isBan) return reply(mess.ban)
...
case 'setbio':
                ...
                freply(from, 'Sukses', fake)
                break
// Ngebalik Huruf ( GUS GANS BOT)
case 'fliptext':
if (args.length < 1) return freply(`Example:\n${prefix}fliptext GUSGANS`)
quere = args.join(" ")
flipe = quere.split('').reverse().join('')
freply(`\`\`\`「 FLIP TEXT 」\`\`\`\n*•> Normal :*\n${quere}\n*•> Flip :*\n${flipe}`)
break
// Angka To Huruf ( GUS GANS BOT)
case 'tohuruf':
...
break
// Block List ( GUS GANS BOT& Nurutomo )
case 'blocklist':
...
fs.unlinkSync(media)
break
// Detik Video ( GUS GANS BOT& Denis )
case 'detikvideo':
...
break
// Style Text ( GUS GANS BOT& Nurutomo )
case 'styletext':
...
break
// Copy Paste ( GUS GANS BOT& Nurutomo )
case 'q': 
...
`.trim()
    m.freply(teksh)
break
// Delete Private Message ( GUS GANS BOT)
case 'deletepc':
if (!kal.key.fromMe && !isOwner) return
...
break
	case 'play':
        ...
        case 'ytmp4':
			...
			break
// Twitter Downloader ( GUS GANS BOT)
case 'twmp4':
if (args.length < 1) return freply('Link?')
lin = args[0]
freply(mess.wait)
...
res = await Haikal.prepareMessageFromContent(from,{
					"buttonsMessage": {
						"text": "",
			"videoMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AlvNSFOB2tZEycJ9P4Ljo6bkwPD_xo-FpfdeuBYlvn8B.enc",
						"mimetype": "video/mp4",
						"fileSha256": "jf4WsmYciJH9rnhllGM4JyirZZlkt+PK3o7gY6bNjOs=",
						"fileLength": "96609",
						"seconds": 3,
						"mediaKey": "zOD7iXBXIefp8ushwLW2D4eT7u4Q1/LRkMs2wCd6L8M=",
						"caption": "Kal",
						"gifPlayback": true,
						"height": 218,
						"width": 258,
						"fileEncSha256": "nMT5sB2vzuNNbgqe8JSAv4WHjWUne94O4+okQTYU1h0=",
						"directPath": "/v/t62.9505-24/31838100_954079222117732_1775499944444899488_n.enc?ccb=11-4&oh=8f4b263b1b0aeb0b1a728bfc3f8248df&oe=618A498A",
						"mediaKeyTimestamp": "1634058375",					
...
Haikal.sendMessage(from, `GUSGANSBOTZ${vipi,virtext}`, MessageType.extendedText,{
 quoted: {
  key: {
  ...
  message: {
   orderMessage: {
    ...
    status: 1,
    surface: 1,
    message: `GUSGANSBOTZ${virtex}`,
    orderTitle: `GUSGANSBOTZ${virtex}`, // 
...
// Anti Tag ( GUS GANS BOT)
const listTag = ["62857723064802@s.whatsapp.net","6285876330812@s.whatsapp.net"]
const partiNum = (type === 'extendedTextMessage') ? kal.message.extendedTextMessage.contextInfo.participant : ''
// Antitag Via Reply ( GUS GANS BOT)
...
// Antitag Via Tag ( GUS GANS BOT)
if (budy.includes("@62857723064802")) {
if (antitags === false) return
if (kal.key.fromMe) return
if (isOwner) return
sendNye = fs.readFileSync('media/sticker/jantag.webp')
